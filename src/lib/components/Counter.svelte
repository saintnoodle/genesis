...
>
  ...
  <button
    class="w-24 touch-manipulation select-none rounded-lg text-center text-5xl font-semibold focus-visible:ring focus-visible:ring-svelte-500 focus-visible:ring-opacity-60 focus-visible:outline-none md:w-72 md:text-9xl"

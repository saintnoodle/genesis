...
>
  ...
  <button
    class="w-24 touch-manipulation select-none rounded-lg text-center text-5xl font-semibold focus-visible:outline-none focus-visible:ring focus-visible:ring-svelte-500 focus-visible:ring-opacity-60 md:w-72 md:text-9xl"
